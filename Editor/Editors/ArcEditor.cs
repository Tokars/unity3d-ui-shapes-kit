...
namespace UIShapeKit.Editor.Editors
{
    ...
    public class ArcEditor : GraphicEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            lineCapProp = serializedObject.FindProperty(nameof(_arc.lineProperties))
                .FindPropertyRelative(nameof(_arc.lineProperties.lineCap));
            CapRoundingPropertiesProp = serializedObject.FindProperty(nameof(_arc.lineProperties))
                .FindPropertyRelative(nameof(_arc.lineProperties.roundedCapResolution));
        }
