...
{
	[CustomEditor(typeof(ValueSetter2))]
	public class FunctionDemoEditor2 : UnityEditor.Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			ValueSetter2 obj = target as ValueSetter2;
			...
			if (obj != null)
			{
				...
				var fields = targetFieldInfos[targetFieldIndex].FieldType
					.GetFields (ValueSetter.binding) // Instance methods, both public and private/protected
